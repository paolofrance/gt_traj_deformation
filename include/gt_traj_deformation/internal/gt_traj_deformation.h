 ...
 */
inline GtTrajDeformation::GtTrajDeformation()
{
}
 ...
 * @return
 */
inline bool GtTrajDeformation::doInit()
{
  //INIT PUB/SUB
  ...
  this->template add_subscriber<sensor_msgs::JointState>(
        setpoint_topic_name,5,boost::bind(&GtTrajDeformation::callback,this,_1), false);
 ...
 * @param time
 */
inline bool GtTrajDeformation::doStarting(const ros::Time& /*time*/)
{
 ...
 * @param time
 */
inline bool GtTrajDeformation::doStopping(const ros::Time& /*time*/)
{
 ...
 * @return
 */
inline bool GtTrajDeformation::doUpdate(const ros::Time& /*time*/, const ros::Duration& period)
{
 ...
 * @param msg
 */
inline void GtTrajDeformation::callback(const sensor_msgs::JointStateConstPtr& msg)
{
